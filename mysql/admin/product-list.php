						...
						if($result){
							while ($row = mysqli_fetch_assoc($result)){
								...
								<tr class="odd gradeX" align="center">
									...
									<td><img src="<?php echo $thumbImage; ?>" width="100px"; height="100px"; alt=""></td>
									<td><?php echo $row['price'];?></td>
									<td><?php echo $row['saleprice'];?></td>
									<td class="center" >
										<a href="product-edit.php?idProducts<?php echo $row['id']; ?>"><i class="fa fa-pencil fa-lg" title="Chỉnh sửa"></i></a>
									</td>
									<td class="center" >
